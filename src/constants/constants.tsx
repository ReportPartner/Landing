...
export const CONTACT_NUMBER = "+7 (700) 021-71-73";
...
export const ALL_PACKAGES: ServicesPackType = [
    ...
    },
    {
        ...
        services: [
                ...
                subservices: [
                    {
                        ...
                        subservices: [
                            ...
                            {
                                title: "Декларация для субъектом малого и среднего бизнеса 910.00",
                                packages: [
                                    {
                                        id: PACKAGES.basic.id,
            ...
            {
                title: "Управленческийи Финансовый учет",
                subservices: [
                    {
...
export const TEAM_MEMBERS: TeamMemberInfoType[] = [
    {
        ...
        content: [
            "Стаж работы 17 лет в крупных международных компаниях с разными видами и критериями деятельности одни из которых Samsung, Теле2, в должности не только Главного бухгалтера, но и финансового директора.",
            [
