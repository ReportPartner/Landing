...
const Services = () => {
    ...
    const procedures = [
        "В случае наличия базы 1C, выполнится ее выгрузка. В случае отсутствия базы 1C, потребуются ключи ЭЦП.",
        "Проверка банковских операций и кассы на соответствие с законом РК.",
        "Проверка дебиторской и кредиторской задолженности на предмет финансовой стабильности компании.",
        "Проверка сданной отчетности на своевременность.",
        "Проверка своевременности начисления заработной платы и начисления налогов.",
        "Проверка соответствия вида деятельности и применяемого налогообложения.",
    ];

    const results = [
        "Экспертное мнение по ведению бухгалтерского и налогового учета.",
        "Рекомендации по исправлению некорректного ведения бухгалтерского и налогового учета.",
